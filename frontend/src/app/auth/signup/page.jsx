...
export default function SignupPage() {
  ...
  const strengthColor = ["bg-neutral-200", "bg-red-400", "bg-orange-400", "bg-yellow-400", "bg-green-500"][strength];
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label htmlFor="firstName" className="block text-xs font-medium uppercase tracking-wider text-neutral-600 mb-1.5">
              First name
            </label>
            <input
              id="firstName"
          ...
          <div>
            <label htmlFor="lastName" className="block text-xs font-medium uppercase tracking-wider text-neutral-600 mb-1.5">
              Last name
            </label>
            <input
              id="lastName"
        ...
        <div>
          <label htmlFor="password" className="block text-xs font-medium uppercase tracking-wider text-neutral-600 mb-1.5">
            Password
          </label>
          <PasswordInput
            id="password"
          ...
          {form.password && (
            <div className="mt-2 flex items-center gap-2">
              ...
              <span className="text-xs text-neutral-500 w-16 text-right">{strengthLabel}</span>
            </div>
          )}
        </div>
