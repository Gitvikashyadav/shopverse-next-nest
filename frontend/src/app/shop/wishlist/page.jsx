          ...
          >
            ...
            <div className="p-4">
              ...
              {isInCart(product.id) ? (
                <Link
                  href="/shop/cart"
                  className="w-full flex items-center justify-center gap-2 rounded-full bg-[var(--gold)] py-3 text-sm font-semibold text-white"
                >
                  <Check size={16} />
                  In bag — View bag
                </Link>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 rounded-full bg-black py-3 text-sm font-semibold text-white transition hover:bg-[var(--gold)]"
                >
                  <ShoppingBag size={16} />
                  Add to cart
                </button>
